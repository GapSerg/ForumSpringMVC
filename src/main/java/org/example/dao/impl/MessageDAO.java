...
public class MessageDAO implements DAO<Message> {
    ...
    public MessageDAO(UserDAO userDAO, BranchDAO branchDAO) {
        ...
        messages.add(new Message(++countMessage, "Hello, gays", new Date(), userDAO.getById(1), branchDAO.getById(3)));
        ...
        messages.add(new Message(++countMessage, "How are you", new Date(), userDAO.getById(1), branchDAO.getById(3)));
